...
const SingleMovie = () => {
  ...
  return (
    <section className="-mt-24">
      {state.error && <div className="">error</div>}
      {state.loading ? (
        <Loading />
      ) : (
        <div
        ...
        >
          <div className="pt-28 bg-gradient-to-t from-[#0c183b8c]  to-[#0c183b8c] w-full h-full flex flex-col gap-5 pb-10 lg:flex-row lg:items-center lg:justify-center">
            ...
            <div className="px-5 flex flex-col gap-4 lg:w-2/4">
              ...
              <div className="flex  justify-evenly lg:justify-start lg:gap-12 items-center">
                ...
                <span className="flex items-center gap-2">
                  <IoIosStar className="text-blue-600" /> {state?.data?.rating}
                </span>
              </div>

              <h1 className="text-gray-300">{state?.data?.description_full}</h1>
