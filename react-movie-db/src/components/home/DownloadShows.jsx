      ...
      <div className="p-5 flex flex-col gap-5 lg:gap-10 md:flex-row md:items-center">
        ...
        <div className="flex flex-col gap-5 md:w-2/4">
          ...
          <div className="group flex flex-col gap-2 mt-2">
            <PiTelevisionThin className="group-hover:bg-primary duration-200 font-bold text-8xl border-dotted border-2 border-primary rounded-full p-3" />
          ...
          <div className="group flex flex-col gap-2 mt-2">
            <IoLocationOutline className="group-hover:bg-primary duration-200 font-bold text-8xl border-dotted border-2 border-primary rounded-full p-3" />
